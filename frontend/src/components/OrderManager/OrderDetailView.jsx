...
const OrderDetailView = ({ order, open, onClose, onStatusChange, role = 'admin', showStatusUpdate = true }) => {
      ...
      <div className={styles.modal}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.leftColumn}>
            ...
            {/* Status Change */}
            {showStatusUpdate && (role === 'admin' || role === 'staff' || (role === 'shipper' && statusOptions.length > 0)) && (
              <div className={styles.section}>
                <div className={styles.sectionHeader}>
